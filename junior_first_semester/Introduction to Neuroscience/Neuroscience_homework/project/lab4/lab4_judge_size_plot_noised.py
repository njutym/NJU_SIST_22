...
# 定义数据目录和文件匹配模式
data_dir = './noised_data'
results_dir = './noised_results'
...
if not files_to_process:
    ...
    # 计算选右的概率
    data['Chose_Right'] = data['Response'] == 'j'  # 将选“右”标记为 True，其他为 False
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(mean_data['Ratio_r'], mean_data['Probability_of_Choosing_Right'], marker='o', linestyle='-', color='g', label='Probability of Choosing Right')
    ...
    # 打印统计结果
    print("Ratio_r  Mean_Reaction_Time  Accuracy  Probability_of_Choosing_Right")
    print(mean_data)
